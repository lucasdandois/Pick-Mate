...
const tiers = [
  ...
  { name: 'Ruby 1', min: 1200, range: '1200-1249', image: '/ruby1.png' },
  { name: 'Ruby 2', min: 1250, range: '1250-1299', image: '/ruby2.png' },
  { name: 'Ruby 3', min: 1300, range: '1300-1349', image: '/ruby3.png' },
  { name: 'Ruby 4', min: 1350, range: '1350-1399', image: '/ruby4.png' },
